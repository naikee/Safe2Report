<x-app-layout>
    ...
    <div class="py-2">
        <div class="mx-auto max-w-screen-2xl p-4  md:p-6 2xl:p-10">
            <div class="mx-auto">
                <form method="POST" action="{{ route('schoolmanagers.update', $user) }}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full lg:w-1/2">
                                        ...
                                        <select id="roles"
                                            ...
                                            <option value="educator"
                                                {{ isset($user) ? ($user->roles == 'educator' ? 'selected' : '') : '' }}>
                                                {{ __('Educator') }}</option>
                                            <option value="admin"
                                ...
                                <div class="flex flex-col lg:flex-row gap-8">
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full">
                                        ...
                                        <x-text-input id="username" name="username" type="text"
                                            class="mt-1 block w-full" :value="old('username', $user->username)" required />
                                ...
                                <div class="flex flex-col lg:flex-row gap-8">
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full">
                                        ...
                                        <x-textarea id="about" name="about" rows="4"
                                            class="mt-1 block w-full">{{ old('about', $user->about) }}</x-textarea>
