                                ...
                                <tr>
                                    <td class="border-b border-[#eee] py-5 px-4">
                                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                                            <div class="h-12.5 w-15 rounded-md">
                                                <img src="{{ asset('storage/media/schools/' . $school->image) }}"
                                                    class="w-12 h-12 rounded-full object-cover"
                                                    alt="{{ $school->name }}">
                                            </div>
                                            <h5 class="text-black font-medium">{{ $school->name }}</h5>
                                        </div>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4">
                                        <p class="text-black">{{ $school->user->name }}</p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4">
                                        <p class="text-black">{{ $school->email }}</p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4">
                                        <p class="text-black">{{ $school->phone }}</p>
                                    </td>
                                    <td class="border-b border-[#eee] py-5 px-4">
                                        @if ($school->status == 1)
                                            <p
                                    ...
                                    <td class="border-b border-[#eee] py-5 px-4">
                                        <div class="flex items-center space-x-0.5">
                                            <x-view-button :href="route('schools.show', $school)" />

                                            <x-edit-button :href="route('schools.edit', $school)" />
