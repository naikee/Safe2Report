                    ...
                    <div class="rounded-sm border pb-10 border-stroke bg-white shadow-default">
                        ...
                        <div class="px-5">
                            <table class="w-full table-auto">
                                ...
                                <tr>
                                    <th class="border-b border-[#eee] py-2 px-4 text-left">{{ __('Phone') }}</th>
                                    <td class="border-b border-[#eee] py-2 px-4">{{ $school->phone }}</td>
                                </tr>
                                <tr>
                                    <th class="border-b border-[#eee] py-2 px-4 text-left">{{ __('Email') }}
                                    </th>
                                    <td class="border-b border-[#eee] py-2 px-4">{{ $school->email }}</td>
                                </tr>
                                <tr>
                                    <th class="border-b border-[#eee] py-2 px-4 text-left">{{ __('Owner') }}
                                    </th>
                                    <td class="border-b border-[#eee] py-2 px-4">{{ $school->user->name }}</td>
                                </tr>
                                <tr>
                                    <th class="border-b border-[#eee] py-2 px-4 text-left">{{ __('Address') }}
                                    </th>
                                    <td class="border-b border-[#eee] py-2 px-4">{{ $school->address->address. ", " .$school->address->lga. ", " .$school->address->state }}</td>
                                </tr>
                                <tr>
                                    <th class="border-b border-[#eee] py-2 px-4 text-left">{{ __('Status') }}</th>
                                    <td class="border-b border-[#eee] py-2 px-4">
                                        @if ($school->status == 1)
                                            <span
