<x-app-layout>
    ...
    <div class="py-2">
        <div class="mx-auto max-w-screen-2xl p-4  md:p-6 2xl:p-10">
            <div class="mx-auto">
                <form method="POST" action="{{ route('myschool.update', $school) }}" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                                ...
                                <div class="flex flex-col lg:flex-row gap-8 pt-2">
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full lg:w-2/3">
                                        ...
                                        <x-text-input id="name" name="name" type="text"
                                            class="mt-1 block w-full" :value="old('name', $school->name)" required />
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full lg:w-1/3">
                                        ...
                                        <select id="status"
                                            ...
                                            name="status">
                                            <option value="0"
                                                {{ isset($school) ? ($school->status == 0 ? 'selected' : '') : '' }}>
                                                {{ __('Inactive') }}</option>
                                            <option value="1"
                                                {{ isset($school) ? ($school->status == 1 ? 'selected' : '') : '' }}>
                                                {{ __('Active') }}</option>
                                        </select>
                                ...
                                <div class="flex flex-col lg:flex-row gap-8">
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full lg:w-1/2">
                                        ...
                                        <x-text-input id="email" name="email" type="email"
                                            class="mt-1 block w-full" :value="old('email', $school->email)" required />
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full lg:w-1/2">
                                        ...
                                        <x-text-input id="phone" name="phone" type="tel"
                                            class="mt-1 block w-full" :value="old('phone', $school->phone)" />
                                ...
                                <div class="flex flex-col lg:flex-row gap-8">
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full">
                                        ...
                                        <x-textarea id="about" name="about" rows="4"
                                            class="mt-1 block w-full">{{ old('about', $school->about) }}</x-textarea>
                                ...
                                <div class="flex flex-col lg:flex-row gap-8">
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full">
                                        ...
                                        <x-text-input id="address" name="address" type="text"
                                            class="mt-1 block w-full" :value="old('address', $school->address->address)" />
                                        ...
                                        <select id="state"
                                            ...
                                            @foreach ($states as $state)
                                                <option value="{{ $state->state }}"
                                                    @isset($school) {{ old('state', $school->address->state) == $state->state ? 'selected' : '' }} @endisset>
                                                    {{ $state->state }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="flex flex-col lg:flex-row gap-8">
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full lg:w-1/2">
                                        ...
                                        <x-text-input id="postal" name="postal" type="text"
                                            class="mt-1 block w-full" :value="old('postal', $school->address->postal)" />
                        ...
                        <div class="col-span-5 xl:col-span-2">
                            <div
                                ...
                                <div class="flex flex-col lg:flex-row gap-8">
                                    ...
                                    <div class="text-base text-gray-600 mt-4 w-full">
                                        ...
                                        <x-text-input id="school_logo"
                                            ...
                                            type="file" name="image" :value="old('image', $school->image)" data-server_image="{{ $school->image }}" />
                                ...
                                <div class="flex items-center justify-end gap-8 mt-6">
                                    <a href="{{ route('myschool.view') }}" class="text-danger">{{ __('Cancel') }}</a>
                                    <x-primary-button
                                        class="font-medium py-3 px-6">{{ __('Update School') }}</x-primary-button>
    ...
    @section('scripts')
        <script>
            $(document).ready(function() {
                ...
                let imageDir = "{{ asset('storage/media/schools') }}";

                $('.school_logo-cover').removeClass('hidden');
                $('.school_logo-cover img').attr('src', imageDir + '/' + $('#school_logo').data('server_image'));
