        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-0">
                    ...
                    <div class="py-2">
                        <div class="mx-auto max-w-screen-2xl p-4  md:p-6 2xl:p-16">
                            <div class="mx-auto">
                                <div
                                    class="rounded-sm border border-stroke bg-white px-16 pt-6 pb-20 shadow-default sm:px-7.5 xl:pb-15">
                                    <form method="POST" action="" enctype="multipart/form-data">
                                        @csrf

                                        <h3 class="font-semibold text-black">
                                            {{ __('Submit a Report. Make a Difference.') }}
                                        </h3>
...
Was Social Media (Facebook, Twitter, Texting, etc.) used to express the problem? If so, select from one of the following:')" />
                                        ...
                                        <div class="flex flex-col lg:flex-row gap-8">
                                            <!-- Associated Social Media Username or URL -->
                                            <div class="text-base text-gray-600 mt-4 w-full lg:w-1/2">
                                                <x-input-label for="sm_username_url" :value="__('Associated Social Media Username or URL')" />
                                                <x-text-input id="sm_username_url" name="sm_username_url" type="text"
                                                    class="mt-1 block w-full" :value="old('sm_username_url')" required />
                                                <x-input-error class="mt-2" :messages="$errors->get('sm_username_url')" />
                                            </div>

                                            <!-- How did you hear about our program?-->
                                            <div class="text-base text-gray-600 mt-4 w-full lg:w-1/2">
                                                <x-input-label for="hear_about_us" :value="__('How did you hear about our program?')" />
                                                <x-text-input id="hear_about_us" name="hear_about_us" type="text"
                                                    class="mt-1 block w-full" :value="old('hear_about_us')" />
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    {{ get_option('copyright', config('app.name', 'Safe 2 Report')) }}
                </footer>
            </div>
        </div>
    </div>
